	...
	helpers : {
		...
		addOffset : function(options, el){
			if(typeof options == 'object' &&
			   ...
			   options.pageY   === undefined && window.teJQuery){
				var el = window.teJQuery(el)
					off = el.offset();
...
if (window.teJQuery) {
	teJQuery.fn.triggerSyn = function(type, options, callback){
...
(function($){
	...
	convertOption = function(option, win, from){
		...
		if (typeof option == 'string') {
			option = teJQuery(option, win.document)[0];
		}
		if (option.nodeName) {
