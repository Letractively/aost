...
TelluriumTestCase.prototype.testSuper = function(){
    var json= [{"obj":{"uid":"comments","locator":{"tag":"div","attributes":{"class":"comments"}},"uiType":"Container","metaData":{"id":"comments","type":"UiObject"}},"key":"comments"},{"obj":{"uid":"input_textarea","locator":{"tag":"textarea","attributes":{"name":"myData[comment]"}},"events":["focus"],"uiType":"InputBox","metaData":{"id":"input_textarea","type":"UiObject"}},"key":"comments.input_textarea"},{"obj":{"uid":"comments_list","locator":{"tag":"ul"},"uiType":"List","separator":"li","metaData":{"id":"comments_list","type":"UiObject"}},"key":"comments.comments_list"},{"obj":{"uid":"_all","locator":{},"uiType":"Container","metaData":{"id":"_all","index":{"value":"all","type":"VAL"},"type":"List"}},"key":"comments.comments_list._all"},{"obj":{"uid":"member","locator":{"tag":"div","attributes":{"class":"member"}},"uiType":"Container","metaData":{"id":"member","type":"UiObject"}},"key":"comments.comments_list._all.member"},{"obj":{"uid":"link","locator":{"tag":"a"},"uiType":"UrlLink","metaData":{"id":"link","type":"UiObject"}},"key":"comments.comments_list._all.member.link"},{"obj":{"uid":"image","locator":{"tag":"img"},"uiType":"Image","metaData":{"id":"image","type":"UiObject"}},"key":"comments.comments_list._all.member.image"},{"obj":{"uid":"txt","locator":{"tag":"div","attributes":{"class":"txt"}},"uiType":"Container","metaData":{"id":"txt","type":"UiObject"}},"key":"comments.comments_list._all.txt"},{"obj":{"uid":"author","locator":{"tag":"div","attributes":{"class":"author"}},"uiType":"Container","metaData":{"id":"author","type":"UiObject"}},"key":"comments.comments_list._all.txt.author"},{"obj":{"uid":"link","locator":{"tag":"a"},"uiType":"UrlLink","metaData":{"id":"link","type":"UiObject"}},"key":"comments.comments_list._all.txt.author.link"},{"obj":{"uid":"tools","locator":{"tag":"div","attributes":{"class":"tools"}},"uiType":"Container","metaData":{"id":"tools","type":"UiObject"}},"key":"comments.comments_list._all.txt.tools"},{"obj":{"uid":"delete","locator":{"text":"Delete","tag":"a"},"events":["click"],"uiType":"UrlLink","metaData":{"id":"delete","type":"UiObject"}},"key":"comments.comments_list._all.txt.tools.delete"},{"obj":{"uid":"description","locator":{"tag":"div","attributes":{"class":"description"}},"uiType":"List","metaData":{"id":"description","type":"UiObject"}},"key":"comments.comments_list._all.txt.description"},{"obj":{"uid":"_all","locator":{"tag":"a"},"uiType":"UrlLink","metaData":{"id":"_all","index":{"value":"all","type":"VAL"},"type":"List"}},"key":"comments.comments_list._all.txt.description._all"},{"obj":{"uid":"date","locator":{"tag":"div","attributes":{"class":"date"}},"uiType":"Container","metaData":{"id":"date","type":"UiObject"}},"key":"comments.comments_list._all.txt.date"},{"obj":{"uid":"title","locator":{"tag":"div","attributes":{"class":"title comment"}},"uiType":"TextBox","metaData":{"id":"title","type":"UiObject"}},"key":"comments.title"},{"obj":{"uid":"post_comment","locator":{"tag":"input","attributes":{"id":"submitComment","value":"Post comment","type":"submit"}},"events":["click"],"uiType":"SubmitButton","metaData":{"id":"post_comment","type":"UiObject"}},"key":"comments.post_comment"},{"obj":{"uid":"input_count","locator":{"attributes":{"id":"inputCount","class":"input"}},"uiType":"TextBox","metaData":{"id":"input_count","type":"UiObject"}},"key":"comments.input_count"}];
...
TelluriumTestCase.prototype.testCheckBox = function(){
    var json = [{"obj":{"uid":"Formprefs","locator":{"tag":"form","attributes":{"id":"aspect_vireo_admin_Settings_div_form-prefs","action":"/vireo101/vireo/admin/settings?update=true&page=user","class":"ds-interactive-div form-prefs","method":"post"}},"uiType":"Form","metaData":{"id":"Formprefs","type":"UiObject"}},"key":"Formprefs"},{"obj":{"uid":"ListTabOptions","locator":{"tag":"div","attributes":{"id":"aspect_vireo_admin_Settings_div_list-tab-options","class":"ds-static-div settings-options"}},"uiType":"Div","metaData":{"id":"ListTabOptions","type":"UiObject"}},"key":"Formprefs.ListTabOptions"},{"obj":{"uid":"ColumnsListFieldset","locator":{"tag":"fieldset","attributes":{"id":"aspect_vireo_admin_Settings_list_display-filters-two","class":"ds-form-list thick display-filters-two pref-optionsasyncParent"}},"uiType":"Container","metaData":{"id":"ColumnsListFieldset","type":"UiObject"}},"key":"Formprefs.ListTabOptions.ColumnsListFieldset"},{"obj":{"uid":"ColumnsList","locator":{"tag":"ol"},"uiType":"List","separator":"li","metaData":{"id":"ColumnsList","type":"UiObject"}},"key":"Formprefs.ListTabOptions.ColumnsListFieldset.ColumnsList"},{"obj":{"uid":"_all","locator":{"tag":"input","attributes":{"type":"checkbox"}},"events":["click"],"uiType":"CheckBox","metaData":{"id":"_all","index":{"value":"all","type":"VAL"},"type":"List"}},"key":"Formprefs.ListTabOptions.ColumnsListFieldset.ColumnsList._all"},{"obj":{"uid":"RecordsPerPageFieldset","locator":{"tag":"fieldset","attributes":{"id":"aspect_vireo_admin_Settings_list_list-page-size","class":"ds-form-list page-size pref-options asyncParent"}},"uiType":"Container","metaData":{"id":"RecordsPerPageFieldset","type":"UiObject"}},"key":"Formprefs.ListTabOptions.RecordsPerPageFieldset"},{"obj":{"uid":"RecordsPerPage","locator":{"tag":"ol"},"uiType":"List","separator":"li","metaData":{"id":"RecordsPerPage","type":"UiObject"}},"key":"Formprefs.ListTabOptions.RecordsPerPageFieldset.RecordsPerPage"},{"obj":{"uid":"_all","locator":{"tag":"input","attributes":{"type":"radio"}},"events":["click"],"uiType":"RadioButton","metaData":{"id":"_all","index":{"value":"all","type":"VAL"},"type":"List"}},"key":"Formprefs.ListTabOptions.RecordsPerPageFieldset.RecordsPerPage._all"},{"obj":{"uid":"FilterOptionsListFieldset","locator":{"tag":"fieldset","attributes":{"id":"aspect_vireo_admin_Settings_list_display-filters-one","class":"ds-form-list thick display-filters-two pref-options asyncParent"}},"uiType":"Container","metaData":{"id":"FilterOptionsListFieldset","type":"UiObject"}},"key":"Formprefs.ListTabOptions.FilterOptionsListFieldset"},{"obj":{"uid":"FilterOptionsList","locator":{"tag":"ol"},"uiType":"List","separator":"li","metaData":{"id":"FilterOptionsList","type":"UiObject"}},"key":"Formprefs.ListTabOptions.FilterOptionsListFieldset.FilterOptionsList"},{"obj":{"uid":"_all","locator":{"tag":"input","attributes":{"type":"checkbox"}},"events":["click"],"uiType":"CheckBox","metaData":{"id":"_all","index":{"value":"all","type":"VAL"},"type":"List"}},"key":"Formprefs.ListTabOptions.FilterOptionsListFieldset.FilterOptionsList._all"}];
    tellurium.logManager.isUseLog = true;
    var uim = new UiModule();
    uim.parseUiModule(json);
    var alg = new UiAlg();
//    alg.allowRelax = true;
    ...
    alg.santa(uim, dom);
    tellurium.cache.cacheOption = true;
    tellurium.cache.addToCache("Formprefs", uim);
    var context = new WorkflowContext();
    context.alg = alg;
    var uiid = new Uiid();
    var tb111 = uim.walkTo(context, uiid.convertToUiid("Formprefs.ListTabOptions.FilterOptionsListFieldset.FilterOptionsList[2]"));
};
