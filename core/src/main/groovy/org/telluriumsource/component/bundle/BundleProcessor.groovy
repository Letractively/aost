...
public class BundleProcessor implements Configurable {
  ...
  public static final String[] NO_BUNDLE_LIST = ["waitForPageToLoad", "waitForCondition", "captureScreenshotToString", "captureEntirePageScreenshotToString", "retrieveLastRemoteControlLogs", "attachFile"];
