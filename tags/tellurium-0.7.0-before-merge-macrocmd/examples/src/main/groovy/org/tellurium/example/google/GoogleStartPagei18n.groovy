 ...
 *
 */
class GoogleStartPagei18n extends DslContext{
...
*/      
        ui.Container(uid: "google_start_page", clocator: [tag: "table"]) {
          InputBox(uid: "searchbox", clocator: [tag: "input", title: "Recherche Google", name: "q"], respond: ["click", "doubleclick"])
          SubmitButton(uid: "googlesearch", clocator: [tag: "input", type: "submit", value: "Recherche Google", name: "btnG"])
          SubmitButton(uid: "Imfeelinglucky", clocator: [tag: "input", type: "submit", value: "J'ai de la chance", name: "btnI"])
        }
