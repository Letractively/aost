...
Grape.grab(group:'org.telluriumsource', module:'tellurium-website', version:'0.8.0-SNAPSHOT', classLoader:this.class.classLoader.rootLoader)
...
@Grapes([
   ...
   @Grab(group='org.telluriumsource', module='tellurium-website', version='0.8.0-SNAPSHOT')
])
