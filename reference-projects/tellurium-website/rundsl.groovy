...
Grape.grab(group:'org.telluriumsource', module:'tellurium-core', version:'0.7.0-RC2', classLoader:this.class.classLoader.rootLoader)
Grape.grab(group:'org.telluriumsource', module:'tellurium-website', version:'0.7.0-RC2', classLoader:this.class.classLoader.rootLoader)
...
Grape.grab(group:'org.seleniumhq.selenium.server', module:'selenium-server', version:'1.0.1-te3-RC2', classLoader:this.class.classLoader.rootLoader)
...
@Grapes([
   ...
   @Grab(group='org.seleniumhq.selenium.server', module='selenium-server', version='1.0.1-te3-RC2'),
   ...
   @Grab(group='org.telluriumsource', module='tellurium-core', version='0.7.0-RC2'),
   @Grab(group='org.telluriumsource', module='tellurium-website', version='0.7.0-RC2')
])
