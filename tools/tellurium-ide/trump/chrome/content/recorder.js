...
Recorder.prototype.attachActionListeners = function(window){
    ...
    teJQuery(window.document).find(":input, a, textarea, button, table, tr, td, th, div").live("mousedown", {recorder: this}, this.rememberClickedListener);
...
Recorder.prototype.detachActionListeners = function(window){
    ...
    teJQuery(window.document).find(":input, a, textarea, button, table, tr, td, th, div").die("mousedown", this.rememberClickedListener);
