...
public class BeanInfo {
    ...
    public String toString(){
        ...
        sb.append("[").append(NAME).append(avpSeparator).append(name).append(fieldSeparator)
                .append(CLAZZ).append(avpSeparator).append(clazz.getCanonicalName()).append(fieldSeparator)
                ...
                .append(SCOPE).append(avpSeparator).append(scope.toString())
                .append("]");
