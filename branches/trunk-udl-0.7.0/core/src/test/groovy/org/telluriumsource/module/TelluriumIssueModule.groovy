...
public class TelluriumIssueModule extends DslContext {
  ...
  public void defineUi() {
    ...
    ui.Table(uid: "issueResult", clocator: [id: "resultstable", class: "results"], group: "true") {
      ...
      UrlLink(uid: "{header: 2} as h2", clocator: [text: "*ID"])
      UrlLink(uid: "{header: 3} as h3", clocator: [text: "*Type"])
      UrlLink(uid: "{header: 4} as h4", clocator: [text: "*Status"])
      UrlLink(uid: "{header: 5} as h5", clocator: [text: "*Priority"])
      UrlLink(uid: "{header: 6} as h6", clocator: [text: "*Milestone"])
      UrlLink(uid: "{header: 7} as h7", clocator: [text: "*Owner"])
      UrlLink(uid: "{header: 9} as h9", clocator: [text: "*Summary + Labels"])
      UrlLink(uid: "{header: 10} as h10", clocator: [text: "*..."])
