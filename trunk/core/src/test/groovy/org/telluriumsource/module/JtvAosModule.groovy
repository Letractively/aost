...
class JtvAosModule extends DslContext{
  public void defineUi() {
 		ui.Form(uid: "Form", clocator: [tag: "form", method: "post", action: "../ivr/InteractiveVoiceResponseAutomatedOrderingSystemService"]){
...
//          TextBox(uid: "xml", clocator: [:])
  ...
  public void login(String name, String password){
		type "Form.VirtualIvrEmployeeUsername", name
		type "Form.VirtualIvrEmployeePassword", password
		click "Form.Submit"
