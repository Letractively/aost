...
//       assertNotNull(table1.findObject("table1"))
       ...
       UiObject obj = table1.ui.walkTo(context, "main.table1[1][1]")
       assertNotNull(obj)
...
//       assertNotNull(table2.findObject("table1"))
       WorkflowContext context = WorkflowContext.getDefaultContext()
       UiObject obj = table2.ui.walkTo(context,"main.table1[1][1]")
       assertNotNull(obj)
       assertTrue(obj instanceof Button)
       assertEquals(context.getReferenceLocator(), "//table/tbody/tr[child::td][1]/td[1]")
   }
...
//       assertNotNull(table3.findObject("table1"))
       WorkflowContext context = WorkflowContext.getDefaultContext()
       UiObject obj = table3.ui.walkTo(context, "main.table1[3][4]")
       assertNotNull(obj)
 ...
 //      assertNotNull(table4.findObject("table1"))
   ...
   void testTable5(){
       ...
       obj = table5.ui.walkTo(context, "main.table1[2][2]")
       assertNotNull(obj)
       assertTrue(obj instanceof Button)
   ...
   void testTable6(){
       ...
       context = WorkflowContext.getDefaultContext()
       obj = table6.ui.walkTo(context, "main.table1[2][2]")
       assertNotNull(obj)
       assertTrue(obj instanceof Button)
       assertEquals(context.getReferenceLocator(), "//table/tbody/tr[child::td][2]/td[2]")
   }
   ...
   void testTable7(){
       ...
       context = WorkflowContext.getDefaultContext()
       obj = table7.ui.walkTo(context, "main.table1[2][2]")
       assertNotNull(obj)
       assertTrue(obj instanceof Button)
       assertEquals(context.getReferenceLocator(), "//table/tbody/tr[child::td][2]/td[2]")
   }
