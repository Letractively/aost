package org.telluriumsource.layer.connector
...
//      CommandProcessor layer = sel.commandProcessor
//      CustomSelenium csel = new CustomSelenium(layer)
...
//        layer.setExtensionJs(userExt.getAbsolutePath())
        layer.setExtensionJs(this.userExtension)
...
//      csel.passCommandProcessor(layer)
